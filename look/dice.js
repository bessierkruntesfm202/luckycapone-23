...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-a74b762d');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-a74b762d');}
...
var brandEl=document.querySelector('.rl-brand-a74b762d');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
